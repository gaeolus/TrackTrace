...
public class BusinessTransactionList {
    ...
    protected List<BusinessTransaction> bizTransaction;
     ...
     * 
     */
    public List<BusinessTransaction> getBizTransaction() {
        if (bizTransaction == null) {
            bizTransaction = new ArrayList<BusinessTransaction>();
        }
        return this.bizTransaction;
    }

	public void setBizTransaction(List<BusinessTransaction> bizTransaction) {
